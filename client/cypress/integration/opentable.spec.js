...
describe('opentable basic tests', () => {
  ...
  it('1.1 - Make the login form appear and disappear when adding an item', () => {
  ...
  it('1.2 - Make the login form appear when adding an item and enter an invalid password', () => {
    // make sure the login form is not visible
    cy.get('#loginForm').should('not.be.visible');
