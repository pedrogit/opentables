...
function ConfigPanel({
  ...
  const handleEditView = React.useCallback(
    (editedView) => {
      const child = { ...view[Globals.childlistFieldName] };
      setViewData({
  ...
  const handleEditList = React.useCallback(
    (editedList) => {
      ...
      if (view[Globals.childlistFieldName][Globals.itemsFieldName]) {
        newViewData[Globals.childlistFieldName][Globals.itemsFieldName] = [
  ...
  const parentListView = {
    [Globals.childlistFieldName]: {
      ...
      [Globals.itemsFieldName]: view[Globals.childlistFieldName]
  ...
  const noListRPerm =
    parentListView[Globals.childlistFieldName][Globals.itemsFieldName][0] ===
              ...
              >
                ...
                <Tab
                  ...
                  label={
                    ...
                    (noListRPerm ? ` (${Globals.permissionDenied})` : "")
                  }
                />
              </Tabs>
            </Box>
            <TabPanel value={value} index={0}>
              {showConfigPanel && (
                <List
                  ...
                  parsedSchema={
                    new Schema(
                      Globals.listOfAllViews[Globals.listSchemaFieldName]
                    )
                  }
                  listSchemaStr={
                    view[Globals.childlistFieldName][
            ...
            <TabPanel value={value} index={1}>
              {showConfigPanel && (
                <List
                  ...
                  parsedSchema={
                    new Schema(
                      Globals.listOfAllLists[Globals.listSchemaFieldName]
                    )
                  }
                  setAuthAPIRequest={setAuthAPIRequest}
