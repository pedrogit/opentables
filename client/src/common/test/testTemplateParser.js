...
describe('testTemplateParser.js List Item TemplateParser', () => {
  ...
  it('Test a non existing property', () => {
    ...
    expect(function(){new TemplateParser(tmpStr, schema);}).to.throw(NodeUtil.format(Errors.ErrMsg.ComponentParser_Invalid, '"' + tmpStr + '"'));
  });
  ...
  it('Test an invalid TemplateParser', () => {
    ...
    expect(function(){new TemplateParser(template, schema);}).to.throw(NodeUtil.format(Errors.ErrMsg.ComponentParser_Invalid, '"[[' + componentStr + ']]"'));
  });
